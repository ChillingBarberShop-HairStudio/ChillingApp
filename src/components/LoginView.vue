...
<template>
  <main class="login-page">
    <section class="login-visual"><div class="login-pole"></div><div class="login-brand"><img src="/logo.PNG" alt="Chilling Barber Shop" /><p>CHILLING BARBER SHOP</p><h1>Vận hành gọn.<br />Tăng trưởng rõ.</h1><span>Chilling OS</span></div></section>
