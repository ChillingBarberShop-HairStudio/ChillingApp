...
const emptyMetrics = (date: string, scope: ReportScope): DashboardMetrics => ({ date, scope, revenue: 0, bookingCount: 0, invoiceCount: 0, expenses: 0, profit: 0, staffCommission: 0, ownerCommission: 0, cash: { count: 0, amount: 0 }, bankTransfer: { count: 0, amount: 0 }, monthlyRevenue: [], staffRank: [], customerRank: [], serviceRank: [] })
